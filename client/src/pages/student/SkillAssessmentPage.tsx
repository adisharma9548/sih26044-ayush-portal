...
export const SkillAssessmentPage: React.FC = () => {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      console.error('[SkillAssessmentPage] Failed to submit exam:', err);
      setSubmitError(err.message || 'Failed to submit evaluation. Please check your network and retry.');
    } finally {
      setSubmitting(false);
    }
  };
    ...
    <div className="max-w-3xl mx-auto space-y-6">
      ...
      {fetchError ? (
        ...
        <div className="bg-white rounded-3xl border border-slate-200/80 p-6 sm:p-8 shadow-xs space-y-6">
          ...
          {submitError && (
            <div className="p-3.5 bg-red-50 border border-red-200 rounded-2xl flex items-center justify-between gap-3 text-xs text-red-700 animate-in fade-in">
              <div className="flex items-center gap-2">
